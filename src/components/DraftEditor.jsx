...
import { FormatBold, FormatItalic, FormatUnderlined, FormatListBulleted, FormatListNumbered, FormatQuote, Code, FormatClear } from '@material-ui/icons';
                ...
                <div className="border p-3">
                    <div className="toolbar ">
                        <div className="clearfix">
                            ...
                            <div className="toolbar-group">
                                <Button type="default" size="middle" onClick={this._clear.bind(this)}>
                                    <FormatClear />
                                </Button>
                            </div>
                        </div>
